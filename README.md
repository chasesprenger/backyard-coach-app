# 🏈 Backyard Coach — Official Desktop App & Releases

[![Platform: macOS | Windows | Web](https://img.shields.io/badge/Platform-macOS%20%7C%20Windows%20%7C%20Web-blue?style=for-the-badge)](https://backyard-coach.surge.sh)
...
- **Tactical Situational Playcaller**: Dynamic play calling recommendations driven by down, distance, field zone, and time remaining.
- **Wireless Sideline-to-Huddle Sync**: Instantaneous play transmission from the sideline coach device directly to the quarterback's on-field wristband.
- **Zero-Drift Referee Clock**: Live synchronized game clocks, play clocks, instant timeout call broadcasting, and `+15s` extension syncing across all sideline devices.
- **Multi-Screen Defensive Playbook**: Formation showcase hubs, vector chalkboard schematic previews, situational defense scores, and pre-snap coverage audibles.
- **Full League & Tournament Hub**: Standings, automated schedules, commissioner code controls, team enrollment, and multi-team record keeping.
- **Synthesized Retro Audio**: Zero-latency 8-bit chiptune audio synthesized using the Web Audio API.

---

## 📜 Copyright & Proprietary Notice

**Copyright © 2026 Chase Sprenger. All Rights Reserved.**

This repository is strictly for the distribution of compiled binary releases and associated documentation.

- **Non-Open Source**: This software is not licensed under MIT, GPL, Apache, or any other open-source or permissive license.
- **No Reproduction or Redistribution**: No part of this software, its binary distributions, assets, or visual designs may be copied, disassembled, reverse-engineered, or modified in any form without prior express written permission.
- **Free End-User Access**: Authorized end users are granted permission to download and use the application free of charge for personal and team sports coaching.
